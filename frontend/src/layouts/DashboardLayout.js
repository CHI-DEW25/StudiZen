            ...
            <div className="relative p-4">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className={`liquidUserBtn ${sidebarCollapsed ? 'is-collapsed' : 'is-expanded'}`}
                  ...
                  >
                    ...
                    {/* Expanded-only content (text + status dot) */}
                    {!sidebarCollapsed && (
                      <>
                        ...
                        {/* Status dot stays inline at the far right */}
                        <span
                          className="liquidUserStatus"
                          aria-hidden="true"
                        />
                      </>
                    )}
